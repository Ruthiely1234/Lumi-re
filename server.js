...
<body>
    ...
    <div id="product-modal" class="modal-overlay">
        <div class="modal">
            ...
            <form id="product-form" onsubmit="saveProduct(event)">
                ...
                <div class="form-group">
                    <label>Arte Visual (URL da Imagem)</label>
                    <input type="url" id="product-image" placeholder="https://exemplo.com/imagem.jpg" oninput="updateImagePreview()">
    ...
    <script>
        ...
        const showSection = (sectionId) => {
            ...
            buttons[0].classList.toggle('active', sectionId === 'store');
            buttons[1].classList.toggle('active', sectionId === 'admin');
        ...
        const loadStoreProducts = async () => {
            ...
            grid.innerHTML = '<div class="loader">Despertando as essências...</div>';
            
            const products = await fetchProducts();
            
            if (products.length === 0) {
                grid.innerHTML = '<div class="loader" style="color: var(--text-secondary); font-size: 1.1rem;">A galeria encontra-se vazia, no aguardo da próxima coleção.</div>';
                return;
            }
            ...
            document.querySelectorAll('.card').forEach((card, index) => {
                // Adiciona um micro atraso cascateado para ficar ainda mais chique
...
app.listen(port, () => {
    console.log(`\n========================================`);
    console.log(`✨ Lumière Haute Parfumerie rodando na porta ${port}`);
    console.log(`========================================\n`);
